...
let units_real = ["npc_dota_units_base", "npc_dota_thinker", "npc_dota_companion", "npc_dota_loadout_generic", "npc_dota_creep_badguys_ranged", "npc_dota_creep_badguys_ranged_upgraded", "npc_dota_creep_badguys_ranged_upgraded_mega", "npc_dota_creep_goodguys_ranged", "npc_dota_creep_goodguys_ranged_upgraded", "npc_dota_creep_goodguys_ranged_upgraded_mega", "npc_dota_creep_badguys_melee", "npc_dota_creep_badguys_melee_upgraded", "npc_dota_creep_badguys_melee_upgraded_mega", "npc_dota_creep_goodguys_melee", "npc_dota_creep_goodguys_melee_upgraded", "npc_dota_creep_goodguys_melee_upgraded_mega", "npc_dota_goodguys_tower1_top", "npc_dota_goodguys_tower1_mid", "npc_dota_goodguys_tower1_bot", "npc_dota_goodguys_tower2_top", "npc_dota_goodguys_tower2_mid", "npc_dota_goodguys_tower2_bot", "npc_dota_goodguys_tower3_top", "npc_dota_goodguys_tower3_mid", "npc_dota_goodguys_tower3_bot", "npc_dota_goodguys_tower4", "npc_dota_badguys_tower1_top", "npc_dota_badguys_tower1_mid", "npc_dota_badguys_tower1_bot", "npc_dota_badguys_tower2_top", "npc_dota_badguys_tower2_mid", "npc_dota_badguys_tower2_bot", "npc_dota_badguys_tower3_top", "npc_dota_badguys_tower3_mid", "npc_dota_badguys_tower3_bot", "npc_dota_badguys_tower4", "npc_dota_watch_tower", "npc_dota_goodguys_fillers", "npc_dota_goodguys_healers", "npc_dota_badguys_fillers", "npc_dota_badguys_healers", "npc_dota_goodguys_melee_rax_top", "npc_dota_goodguys_melee_rax_mid", "npc_dota_goodguys_melee_rax_bot", "npc_dota_goodguys_range_rax_top", "npc_dota_goodguys_range_rax_mid", "npc_dota_goodguys_range_rax_bot", "npc_dota_badguys_melee_rax_top", "npc_dota_badguys_melee_rax_mid", "npc_dota_badguys_melee_rax_bot", "npc_dota_badguys_range_rax_top", "npc_dota_badguys_range_rax_mid", "npc_dota_badguys_range_rax_bot", "npc_dota_goodguys_fort", "npc_dota_badguys_fort", "npc_dota_goodguys_siege", "npc_dota_goodguys_siege_upgraded", "npc_dota_goodguys_siege_upgraded_mega", "npc_dota_badguys_siege", "npc_dota_badguys_siege_upgraded", "npc_dota_badguys_siege_upgraded_mega", "dota_fountain", "npc_dota_juggernaut_healing_ward", "npc_dota_healing_campfire", "npc_dota_zeus_cloud", "npc_dota_tusk_frozen_sigil1", "npc_dota_tusk_frozen_sigil2", "npc_dota_tusk_frozen_sigil3", "npc_dota_tusk_frozen_sigil4", "npc_dota_elder_titan_ancestral_spirit", "npc_dota_neutral_kobold", "npc_dota_neutral_kobold_tunneler", "npc_dota_neutral_kobold_taskmaster", "npc_dota_neutral_centaur_outrunner", "npc_dota_neutral_centaur_khan", "npc_dota_neutral_fel_beast", "npc_dota_neutral_polar_furbolg_champion", "npc_dota_neutral_polar_furbolg_ursa_warrior", "npc_dota_neutral_mud_golem", "npc_dota_neutral_mud_golem_split", "npc_dota_neutral_mud_golem_split_doom", "npc_dota_neutral_ogre_mauler", "npc_dota_neutral_ogre_magi", "npc_dota_neutral_giant_wolf", "npc_dota_neutral_alpha_wolf", "npc_dota_neutral_wildkin", "npc_dota_neutral_enraged_wildkin", "npc_dota_neutral_satyr_soulstealer", "npc_dota_neutral_satyr_hellcaller", "npc_dota_neutral_jungle_stalker", "npc_dota_neutral_elder_jungle_stalker", "npc_dota_neutral_prowler_acolyte", "npc_dota_neutral_prowler_shaman", "npc_dota_neutral_rock_golem", "npc_dota_neutral_granite_golem", "npc_dota_neutral_big_thunder_lizard", "npc_dota_neutral_small_thunder_lizard", "npc_dota_neutral_gnoll_assassin", "npc_dota_neutral_ghost", "npc_dota_wraith_ghost", "npc_dota_neutral_dark_troll", "npc_dota_neutral_dark_troll_warlord", "npc_dota_neutral_satyr_trickster", "npc_dota_neutral_forest_troll_berserker", "npc_dota_neutral_forest_troll_high_priest", "npc_dota_neutral_harpy_scout", "npc_dota_neutral_harpy_storm", "npc_dota_neutral_black_drake", "npc_dota_neutral_black_dragon", "npc_dota_necronomicon_warrior_1", "npc_dota_necronomicon_warrior_2", "npc_dota_necronomicon_warrior_3", "npc_dota_necronomicon_archer_1", "npc_dota_necronomicon_archer_2", "npc_dota_necronomicon_archer_3", "npc_dota_observer_wards", "npc_dota_sentry_wards", "npc_dota_courier", "npc_dota_flying_courier", "npc_dota_witch_doctor_death_ward", "npc_dota_shadow_shaman_ward_1", "npc_dota_shadow_shaman_ward_2", "npc_dota_shadow_shaman_ward_3", "npc_dota_venomancer_plague_ward_1", "npc_dota_venomancer_plague_ward_2", "npc_dota_venomancer_plague_ward_3", "npc_dota_venomancer_plague_ward_4", "npc_dota_lesser_eidolon", "npc_dota_eidolon", "npc_dota_greater_eidolon", "npc_dota_dire_eidolon", "npc_dota_furion_treant_1", "npc_dota_furion_treant_2", "npc_dota_furion_treant_3", "npc_dota_furion_treant_4", "npc_dota_furion_treant_large", "npc_dota_invoker_forged_spirit", "npc_dota_broodmother_spiderling", "npc_dota_broodmother_spiderite", "npc_dota_dark_troll_warlord_skeleton_warrior", "npc_dota_wraith_king_skeleton_warrior", "npc_dota_clinkz_skeleton_archer", "npc_dota_enraged_wildkin_tornado", "npc_dota_roshan", "npc_dota_roshan_halloween", "npc_dota_roshan_halloween_minion", "ent_dota_radiant_candybucket", "ent_dota_dire_candybucket", "npc_dota_warlock_golem_1", "npc_dota_warlock_golem_2", "npc_dota_warlock_golem_3", "npc_dota_warlock_golem_scepter_1", "npc_dota_warlock_golem_scepter_2", "npc_dota_warlock_golem_scepter_3", "npc_dota_scout_hawk", "npc_dota_greater_hawk", "npc_dota_beastmaster_hawk", "npc_dota_beastmaster_hawk_1", "npc_dota_beastmaster_hawk_2", "npc_dota_beastmaster_hawk_3", "npc_dota_beastmaster_hawk_4", "npc_dota_beastmaster_boar", "npc_dota_beastmaster_greater_boar", "npc_dota_beastmaster_boar_1", "npc_dota_beastmaster_boar_2", "npc_dota_beastmaster_boar_3", "npc_dota_beastmaster_boar_4", "npc_dota_brewmaster_earth_1", "npc_dota_brewmaster_earth_2", "npc_dota_brewmaster_earth_3", "npc_dota_brewmaster_storm_1", "npc_dota_brewmaster_storm_2", "npc_dota_brewmaster_storm_3", "npc_dota_brewmaster_fire_1", "npc_dota_brewmaster_fire_2", "npc_dota_brewmaster_fire_3", "npc_dota_unit_tombstone1", "npc_dota_unit_tombstone2", "npc_dota_unit_tombstone3", "npc_dota_unit_tombstone4", "npc_dota_unit_undying_zombie", "npc_dota_unit_undying_zombie_torso", "npc_dota_pugna_nether_ward_1", "npc_dota_pugna_nether_ward_2", "npc_dota_pugna_nether_ward_3", "npc_dota_pugna_nether_ward_4", "npc_dota_templar_assassin_psionic_trap", "npc_dota_rattletrap_cog", "npc_dota_rattletrap_rocket", "npc_dota_broodmother_web", "npc_dota_stormspirit_remnant", "npc_dota_ember_spirit_remnant", "npc_dota_earth_spirit_stone", "npc_dota_slark_visual", "npc_dota_weaver_swarm", "npc_dota_death_prophet_torment", "npc_dota_gyrocopter_homing_missile", "npc_dota_plasma_field", "npc_dota_metamorphosis_fear", "npc_dota_lycan_wolf1", "npc_dota_lycan_wolf2", "npc_dota_lycan_wolf3", "npc_dota_lycan_wolf4", "npc_dota_lycan_wolf_lane", "npc_dota_lone_druid_bear1", "npc_dota_lone_druid_bear2", "npc_dota_lone_druid_bear3", "npc_dota_lone_druid_bear4", "npc_dota_visage_familiar1", "npc_dota_visage_familiar2", "npc_dota_visage_familiar3", "ent_dota_halloffame", "ent_dota_promo", "npc_dota_wisp_spirit", "npc_dota_beastmaster_axe", "npc_dota_troll_warlord_axe", "npc_dota_creep_goodguys_melee_diretide", "npc_dota_creep_goodguys_ranged_diretide", "npc_dota_creep_badguys_melee_diretide", "npc_dota_creep_badguys_ranged_diretide", "npc_dota_goodguys_siege_diretide", "npc_dota_badguys_siege_diretide", "npc_dota_halloween_chaos_unit", "npc_dota_roquelaire", "npc_dota_greevil", "npc_dota_loot_greevil", "npc_dota_greevil_miniboss_black", "npc_dota_greevil_miniboss_blue", "npc_dota_greevil_miniboss_red", "npc_dota_greevil_miniboss_yellow", "npc_dota_greevil_miniboss_white", "npc_dota_greevil_minion_white", "npc_dota_greevil_minion_black", "npc_dota_greevil_minion_red", "npc_dota_greevil_minion_blue", "npc_dota_greevil_minion_yellow", "npc_dota_greevil_miniboss_green", "npc_dota_greevil_miniboss_orange", "npc_dota_greevil_miniboss_purple", "npc_dota_greevil_minion_orange", "npc_dota_greevil_minion_purple", "npc_dota_greevil_minion_green", "npc_dota_phoenix_sun", "npc_dota_ignis_fatuus", "npc_dota_target_dummy", "npc_dota_looping_sound", "npc_dota_invisible_vision_source", "npc_dota_techies_land_mine", "npc_dota_techies_stasis_trap", "npc_dota_techies_remote_mine", "npc_dota_techies_minefield_sign", "npc_dota_treant_eyes", "npc_dota_phantomassassin_gravestone", "npc_dota_goodguys_cny_beast", "npc_dota_badguys_cny_beast", "dota_death_prophet_exorcism_spirit", "npc_dota_dark_willow_creature", "npc_dota_mutation_pocket_roshan", "npc_dota_grimstroke_ink_creature", "npc_dota_seasonal_snowman", "npc_dota_frostivus2018_snowman", "npc_dota_seasonal_dragon", "npc_dota_seasonal_cny_balloon", "npc_dota_seasonal_ti9_balloon", "npc_dota_seasonal_ti9_drums", "npc_dota_seasonal_ti9_monkey", "npc_dota_seasonal_ti9_shovel_baby_roshan", "npc_dota_seasonal_ti9_shovel_ghost", "npc_dota_seasonal_ti9_shovel_stasis_trap", "npc_dota_seasonal_ti9_shovel_pudgling", "npc_dota_aether_remnant", "npc_dota_seasonal_penguin"]
let units = units_real.map(name => {
	name = name.startsWith("npc_dota_") ? name.substring(9) : name
	return name.startsWith("neutral_") ? name.substring(8) : name
})
...
ability_list.forEach(abil => {
	...
	let path = is_item ? "Items/" : `Abilities/${folder}/`
...
units.forEach(unit => {
	let search_str = StandartifyString(unit)
	let class_name = TryFindClass("C_DOTA_Unit_Hero_", search_str) || TryFindClass("CDOTA_Unit_Hero_", search_str)
})
