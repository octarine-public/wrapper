...
interface EventsSDK extends EventEmitter {
	 ...
	 */
	on(name: "PreEntityCreated", callback: (ent: Entity) => void, priority?: number): EventEmitter
	/**
	 ...
	 */
	on(name: "EntityCreated", callback: (ent: Entity) => void, priority?: number): EventEmitter
	on(name: "EntityDestroyed", callback: (ent: Entity) => void, priority?: number): EventEmitter
	/**
	...
	on(name: "ParticleUpdated", callback: (particle: NetworkedParticle) => void, priority?: number): EventEmitter
	on(name: "ParticleUnitPositionUpdated", callback: (unit: FakeUnit | Unit, particle: Nullable<NetworkedParticle>) => void, priority?: number): EventEmitter
	on(name: "ParticleReleased", listener: (particle: NetworkedParticle) => void, priority?: number): EventEmitter
	on(name: "ParticleDestroyed", listener: (particle: NetworkedParticle) => void, priority?: number): EventEmitter
	on(name: "BloodImpact", callback: (target: Nullable<Unit | FakeUnit>, scale: number, xnormal: number, ynormal: number) => void, priority?: number): EventEmitter
	on(name: "PrepareUnitOrders", callback: (order: ExecuteOrder) => false | any, priority?: number): EventsSDK
	on(name: "DebuggerPrepareUnitOrders", callback: (order: ExecuteOrder, is_user_input: boolean, was_cancelled: boolean) => void, priority?: number): EventEmitter
	on(name: "LinearProjectileCreated", callback: (proj: LinearProjectile) => void, priority?: number): EventEmitter
	on(name: "LinearProjectileDestroyed", callback: (proj: LinearProjectile) => void, priority?: number): EventEmitter
	...
	on(name: "GameEvent", listener: (event_name: string, obj: any) => void, priority?: number): EventEmitter
	on(
		name: "UnitSpeech", listener: (
	...
	on(name: "UnitSpeechMute", listener: (npc: Nullable<Unit | FakeUnit>, delay: number) => void, priority?: number): EventEmitter
	on(
		name: "UnitAddGesture",
		listener: (
			npc: Nullable<Unit | FakeUnit>,
	...
	on(name: "UnitRemoveGesture", listener: (npc: Nullable<Unit | FakeUnit>, activity: number) => void, priority?: number): EventEmitter
	on(name: "UnitFadeGesture", listener: (npc: Nullable<Unit | FakeUnit>, activity: number) => void, priority?: number): EventEmitter
	on(name: "InputCaptured", listener: (is_captured: boolean) => void, priority?: number): EventEmitter
	on(name: "LifeStateChanged", listener: (ent: Entity) => void, priority?: number): EventEmitter
	on(name: "UnitAbilitiesChanged", listener: (ent: Unit) => void, priority?: number): EventEmitter
	on(name: "UnitWearablesChanged", listener: (ent: Unit) => void, priority?: number): EventEmitter
	on(name: "UnitItemsChanged", listener: (ent: Unit) => void, priority?: number): EventEmitter
	on(name: "EntityTeamChanged", listener: (ent: Entity) => void, priority?: number): EventEmitter
	on(name: "NetworkActivityChanged", listener: (npc: Unit) => void, priority?: number): EventEmitter
	on(name: "ModifierCreated", listener: (mod: Modifier) => void, priority?: number): EventEmitter
	on(name: "ModifierChanged", listener: (mod: Modifier) => void, priority?: number): EventEmitter
	on(name: "ModifierRemoved", listener: (mod: Modifier) => void, priority?: number): EventEmitter
	on(
		name: "ServerTick",
		listener: (
			tick: number,
