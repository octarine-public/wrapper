...
export class modifier_viper_corrosive_skin extends Modifier {
	...
	public PostDataUpdate(): void {
		...
		if (caster === undefined) {
			this.cachedMres = this.cachedBaseMres
			return
		}
		...
		this.cachedMres = this.cachedBaseMres * (1 + modifier.EffMultiplier)
	}
	...
	protected UpdateSpecialValues(): void {
		this.cachedBaseMres = this.GetSpecialValue(
