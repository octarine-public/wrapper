...
export class modifier_dragon_knight_dragon_form extends Modifier implements IBuff {
	public readonly IsHidden = false
	public readonly BuffModifierName = this.Name

	private cachedSpeed = 0
	private cachedRange = 0
	private cachedMagicResist = 0
	...
	protected GetMagicalResistanceBonus(): [number, boolean] {
		return [this.cachedMagicResist, false]
	}
	protected UpdateSpecialValues(): void {
		...
		this.cachedMagicResist = this.GetSpecialValue("magic_resistance", name)
	}
