...
export class modifier_minotaur_horn_immune extends Modifier implements IShield, IBuff {
	...
	protected UpdateSpecialValues() {
		this.cachedMres = this.GetSpecialValue("magic_resist", "item_minotaur_horn")
	}
}
