...
export class modifier_item_desolator extends Modifier {
	...
	protected GetPhysicalArmorPreAttackBonusTarget(
		...
		if (target === undefined || target.HasBuffByName("modifier_desolator_buff")) {
			return [0, false]
		}
	...
	protected UpdateSpecialValues() {
		this.cachedPreArmor = this.GetSpecialValue("corruption_armor", "item_desolator")
	}
}
