export const enum EModifierfunction {
	...
	// custom
	MODIFIER_PROPERTY_PREATTACK_PHYSICAL_ARMOR_BONUS_TARGET = 379,
	MODIFIER_PROPERTY_PREATTACK_PHYSICAL_ARMOR_BONUS_TARGET_STACKING = 380,
	MODIFIER_PROPERTY_PREATTACK_BONUS_DAMAGE_PERCENTAGE = 381,
	MODIFIER_PROPERTY_PREATTACK_RAW_INCOMING_DAMAGE_PERCENTAGE = 382,
	MODIFIER_PROPERTY_PREATTACK_INCOMING_DAMAGE_PERCENTAGE = 383,
	MODIFIER_PROPERTY_PROCATTACK_INCOMING_DAMAGE_PERCENTAGE = 384,
	MODIFIER_PROPERTY_IGNORE_PREATTACK_BONUS_DAMAGE = 385,
	MODIFIER_PROPERTY_RAW_MAGICAL_CONSTANT_BLOCK = 386,
	MODIFIER_PROPERTY_CURIO_MULTIPLIER_BONUS_CONSTANT = 387,
	MODIFIER_PROPERTY_LINKEN_PROTECTION = 388,
	MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_PERCENTAGE_POST = 389,
	MODIFIER_FUNCTION_LAST = 390,
