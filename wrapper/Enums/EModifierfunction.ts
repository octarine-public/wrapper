export const enum EModifierfunction {
	...
	// custom
	MODIFIER_PROPERTY_PREATTACK_PHYSICAL_ARMOR_BONUS_TARGET = 370,
	MODIFIER_PROPERTY_PREATTACK_BONUS_DAMAGE_PERCENTAGE = 371,
	MODIFIER_PROPERTY_PREATTACK_RAW_INCOMING_DAMAGE_PERCENTAGE = 372,
	MODIFIER_PROPERTY_PREATTACK_INCOMING_DAMAGE_PERCENTAGE = 373,
	MODIFIER_PROPERTY_PROCATTACK_INCOMING_DAMAGE_PERCENTAGE = 374,
	MODIFIER_PROPERTY_IGNORE_PREATTACK_BONUS_DAMAGE = 375,
	MODIFIER_PROPERTY_RAW_MAGICAL_CONSTANT_BLOCK = 376,
	MODIFIER_FUNCTION_LAST = 377,
