...
export function GetMapArea(pos: Vector3 | Vector2, ignore_bases = false): [MapArea, Team] {
	if (!ignore_bases)
	...
	if (nearest_corner.Distance2D(pos) < 1550)
		return [nearest_corner.Spawner!.Lane, GetPathCornerNearestTeam(nearest_corner)]
...
export function GetCreepCurrentTarget(position: Vector3 | Vector2, team: Team, lane = MapArea.Unknown): Nullable<CreepPathCorner> {
