...
const OptimizeTree = BaseTree.AddNode("Optimize FPS")
export const OptimizeState = OptimizeTree.AddToggle("Enable", true)
export const OptimizeSlider = OptimizeTree.AddSlider("Display creeps in range hero", 2000, 150, 8000)
