...
let sky: Hero = undefined,
    ...
    heroes: Hero[] = [],
    targetParticle: number = undefined,
    comboKeyPress = false,
    ...
    bolt: Ability =undefined,
    shot: Ability =undefined,
    seal: Ability =undefined,
    flare: Ability =undefined,
    atos: Item = undefined,
    nullifier: Item = undefined,
    hex: Item = undefined,
    veil: Item = undefined,
    eblade: Item = undefined,
    dagon: Item = undefined,
    orchid: Item = undefined,
    blood: Item = undefined,
    shiva: Item = undefined,
    cyclone: Item = undefined,
    forcestaff: Item = undefined,
    hurricane: Item = undefined,
    soulring: Item = undefined,
    blink: Item = undefined,
    debuffed = false,
    IsEZKillable = false,
    cshotenemy: Hero = undefined,
    currentcshot: Hero = undefined,
    cshotparticle: number = undefined,
    ...
    if(drawStatus.value){
        ...
        text.forEach((val,i)=>{
            Renderer.Text(
                ...
                val, 255, 255, 255, 100, "Radiance",textSize.value
            );
        })
    }
})