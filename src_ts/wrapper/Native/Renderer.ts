...
class RendererSDK {
	 ...
	 */
	public get DefaultTextSize(): Vector2 {
	 ...
	 */
	public get DefaultShapeSize(): Vector2 {
	 ...
	 *
	 */
	public FilledCircle(vec: Vector2 | Vector3 = new Vector2(), radius: number, color = new Color(255, 255, 255)): void {
		Renderer.FilledCircle(vec.x, vec.y, radius, color.r, color.g, color.b, color.a)
	}
	/**
	 *
	 */
	public OutlinedCircle(vec: Vector2 | Vector3 = new Vector2(), radius: number, color = new Color(255, 255, 255)): void {
	 ...
	 */
	public Text(text: string, vec: Vector2 | Vector3 = new Vector2(), color = new Color(255, 255, 255), font_name = "Calibri", font: Vector2 | number = this.DefaultTextSize, flags = FontFlags_t.OUTLINE): void {
