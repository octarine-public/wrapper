...
export function XAIOMenuHero(rootTree: Menu.Node, name: string, tooltip?: string) {
	...
	const XAIOSettingsBladMailTree = XAIOSettingsMenu.AddNode("Checking on Bald Mail")
	...
	const XAIORenderBindKey = XAIOExtraSettingsRadiuses.AddKeybind(XAIOSelectLanguage("Кнопка бинда", "Key bind"), "Alt")
	...
	const XAIORenderOptimizeType = XAIOExtraSettingsRadiuses.AddSwitcher("Render optimize type", ["onDraw", "onTick"], 1)
	...
	const XIAODrawingtargetState = XAIODrawingtargetNode.AddToggle(XAIOSelectLanguage("Вкл/выкл", "On/off"))
	...
	return {
		...
		XAIONearMouse: XAIOSettingsMenu.AddSlider("Near mouse", 200, 50, 1000),
	}
}
