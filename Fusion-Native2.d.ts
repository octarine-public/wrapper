...
declare class CFootCycleDefinition {
	...
	m_vMidpointPositionMS: boolean // returns Vector3 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
...
declare class handposepair_t {
	readonly m_vMaxExtentOrigin: boolean[] // returns Vector3 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
	readonly m_vMinExtentOrigin: boolean[] // returns Vector3 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
...
declare class WorldBuilderParams_t {
	...
	m_vLightmapUvScale: boolean // returns Vector2 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
}
...
declare class C_BasePlayer extends C_BaseCombatCharacter {
	...
	m_angDemoViewAngles: boolean // returns QAngle to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
...
declare class shard_model_desc_t {
	...
	m_vecPanelSize: boolean // returns Vector2 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
	m_vecStressPositionA: boolean // returns Vector2 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
	m_vecStressPositionB: boolean // returns Vector2 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
	readonly m_vecPanelVertices: boolean[] // returns Vector2 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set[]
...
declare class CShatterGlassShard {
	...
	readonly m_vecPanelVertices: boolean[] // returns Vector2 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set[]
	m_vLocalPanelSpaceOrigin: boolean // returns Vector2 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
	...
	m_vecStressVelocity: boolean // returns Vector3 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
	...
	m_vecAverageVertPosition: boolean // returns Vector2 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
	m_bAverageVertPositionIsValid: boolean
	m_vecPanelSpaceStressPositionA: boolean // returns Vector2 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
	m_vecPanelSpaceStressPositionB: boolean // returns Vector2 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
	...
	m_hEntityHittingMe: CEntityIndex // C_BaseEntity
...
declare class lerpdata_t {
	...
	m_MoveType: MoveType_t
	m_flStartTime: number
	m_vecStartOrigin: boolean // returns Vector3 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
...
declare class C_DOTA_Ability_DrowRanger_Multishot extends C_DOTABaseAbility {
	...
	arrow_spread: number
	arrow_count: number
	readonly m_vHitTargets0: CEntityIndex[] // C_BaseEntity[]
	readonly m_vHitTargets1: CEntityIndex[] // C_BaseEntity[]
	readonly m_vHitTargets2: CEntityIndex[] // C_BaseEntity[]
	readonly m_vHitTargets3: CEntityIndex[] // C_BaseEntity[]
}
...
declare class C_DOTA_Ability_ChaosKnight_Reality_Rift extends C_DOTABaseAbility {
	...
	m_hRiftIllusion: CEntityIndex // C_BaseEntity
}
...
declare class C_PathParticleRope extends C_BaseEntity {
	...
	m_flSlack: number
	m_flRadius: number
	m_ColorTint: boolean // returns Color to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
	m_nEffectState: number
	readonly m_PathNodes_Position: boolean[] // returns Vector3 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set[]
	readonly m_PathNodes_TangentIn: boolean[] // returns Vector3 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set[]
...
declare class CAnimGraphNetworkedVariables {
	...
	m_NetRootPosition: boolean // returns Vector3 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
	...
	m_PredNetRootPosition: boolean // returns Vector3 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
	...
	m_LocalPredRootPosition: boolean // returns Vector3 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
}
...
declare class CDOTA_Item_Demonicon extends C_DOTA_Item {
	readonly m_hDemonSummons: CEntityIndex[] // C_BaseEntity[]
}
...
declare class CDOTA_Item_Trusty_Shovel extends C_DOTA_Item {
	m_vChannelPos: boolean // returns Vector3 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
...
declare class C_BasePropDoor extends C_DynamicProp {
	...
	m_bLocked: boolean
	m_closedPosition: boolean // returns Vector3 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
	m_closedAngles: boolean // returns QAngle to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
	m_hMaster: CEntityIndex // C_BasePropDoor
	m_vWhereToSetLightingOrigin: boolean // returns Vector3 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
}
...
declare class CDOTA_Ability_VoidSpirit_AetherRemnant extends C_DOTABaseAbility {
	...
	m_vBasePoint: boolean // returns Vector3 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
	readonly m_nFXTarget: ParticleIndex_t
	m_bHasDashPosition: boolean
	m_vDashPosition: boolean // returns Vector3 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
	m_bHasFacePosition: boolean
	m_vFacePosition: boolean // returns Vector3 to IOBuffer offset 0 on get, sets from IOBuffer offset 0 on set
	start_radius: number
	end_radius: number
...
declare enum modifierfunction {
	...
	MODIFIER_PROPERTY_HP_REGEN_AMPLIFY_PERCENTAGE_SOURCE = 41,
	MODIFIER_PROPERTY_HP_REGEN_AMPLIFY_PERCENTAGE = 42,
	MODIFIER_PROPERTY_LIFESTEAL_AMPLIFY_PERCENTAGE = 43,
	MODIFIER_PROPERTY_MP_REGEN_AMPLIFY_PERCENTAGE = 44,
	MODIFIER_PROPERTY_MP_RESTORE_AMPLIFY_PERCENTAGE = 45,
	MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE = 46,
	MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE_UNIQUE = 47,
	MODIFIER_PROPERTY_INCOMING_DAMAGE_PERCENTAGE = 48,
	MODIFIER_PROPERTY_INCOMING_PHYSICAL_DAMAGE_PERCENTAGE = 49,
	MODIFIER_PROPERTY_INCOMING_PHYSICAL_DAMAGE_CONSTANT = 50,
	MODIFIER_PROPERTY_INCOMING_SPELL_DAMAGE_CONSTANT = 51,
	MODIFIER_PROPERTY_EVASION_CONSTANT = 52,
	MODIFIER_PROPERTY_NEGATIVE_EVASION_CONSTANT = 53,
	MODIFIER_PROPERTY_STATUS_RESISTANCE = 54,
	MODIFIER_PROPERTY_STATUS_RESISTANCE_STACKING = 55,
	MODIFIER_PROPERTY_STATUS_RESISTANCE_CASTER = 56,
	MODIFIER_PROPERTY_AVOID_DAMAGE = 57,
	MODIFIER_PROPERTY_AVOID_SPELL = 58,
	MODIFIER_PROPERTY_MISS_PERCENTAGE = 59,
	MODIFIER_PROPERTY_PHYSICAL_ARMOR_BASE_PERCENTAGE = 60,
	MODIFIER_PROPERTY_PHYSICAL_ARMOR_TOTAL_PERCENTAGE = 61,
	MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS = 62,
	MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_UNIQUE = 63,
	MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_UNIQUE_ACTIVE = 64,
	MODIFIER_PROPERTY_IGNORE_PHYSICAL_ARMOR = 65,
	MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BASE_REDUCTION = 66,
	MODIFIER_PROPERTY_MAGICAL_RESISTANCE_DIRECT_MODIFICATION = 67,
	MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS = 68,
	MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS_ILLUSIONS = 69,
	MODIFIER_PROPERTY_MAGICAL_RESISTANCE_DECREPIFY_UNIQUE = 70,
	MODIFIER_PROPERTY_BASE_MANA_REGEN = 71,
	MODIFIER_PROPERTY_MANA_REGEN_CONSTANT = 72,
	MODIFIER_PROPERTY_MANA_REGEN_CONSTANT_UNIQUE = 73,
	MODIFIER_PROPERTY_MANA_REGEN_TOTAL_PERCENTAGE = 74,
	MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT = 75,
	MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE = 76,
	MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE_UNIQUE = 77,
	MODIFIER_PROPERTY_HEALTH_BONUS = 78,
	MODIFIER_PROPERTY_MANA_BONUS = 79,
	MODIFIER_PROPERTY_EXTRA_STRENGTH_BONUS = 80,
	MODIFIER_PROPERTY_EXTRA_HEALTH_BONUS = 81,
	MODIFIER_PROPERTY_EXTRA_MANA_BONUS = 82,
	MODIFIER_PROPERTY_EXTRA_HEALTH_PERCENTAGE = 83,
	MODIFIER_PROPERTY_EXTRA_MANA_PERCENTAGE = 84,
	MODIFIER_PROPERTY_STATS_STRENGTH_BONUS = 85,
	MODIFIER_PROPERTY_STATS_AGILITY_BONUS = 86,
	MODIFIER_PROPERTY_STATS_INTELLECT_BONUS = 87,
	MODIFIER_PROPERTY_STATS_STRENGTH_BONUS_PERCENTAGE = 88,
	MODIFIER_PROPERTY_STATS_AGILITY_BONUS_PERCENTAGE = 89,
	MODIFIER_PROPERTY_STATS_INTELLECT_BONUS_PERCENTAGE = 90,
	MODIFIER_PROPERTY_CAST_RANGE_BONUS = 91,
	MODIFIER_PROPERTY_CAST_RANGE_BONUS_TARGET = 92,
	MODIFIER_PROPERTY_CAST_RANGE_BONUS_STACKING = 93,
	MODIFIER_PROPERTY_ATTACK_RANGE_BASE_OVERRIDE = 94,
	MODIFIER_PROPERTY_ATTACK_RANGE_BONUS = 95,
	MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_UNIQUE = 96,
	MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_PERCENTAGE = 97,
	MODIFIER_PROPERTY_MAX_ATTACK_RANGE = 98,
	MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS = 99,
	MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS_PERCENTAGE = 100,
	MODIFIER_PROPERTY_PROJECTILE_NAME = 101,
	MODIFIER_PROPERTY_REINCARNATION = 102,
	MODIFIER_PROPERTY_RESPAWNTIME = 103,
	MODIFIER_PROPERTY_RESPAWNTIME_PERCENTAGE = 104,
	MODIFIER_PROPERTY_RESPAWNTIME_STACKING = 105,
	MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE = 106,
	MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_ONGOING = 107,
	MODIFIER_PROPERTY_CASTTIME_PERCENTAGE = 108,
	MODIFIER_PROPERTY_MANACOST_PERCENTAGE = 109,
	MODIFIER_PROPERTY_MANACOST_PERCENTAGE_STACKING = 110,
	MODIFIER_PROPERTY_DEATHGOLDCOST = 111,
	MODIFIER_PROPERTY_EXP_RATE_BOOST = 112,
	MODIFIER_PROPERTY_PREATTACK_CRITICALSTRIKE = 113,
	MODIFIER_PROPERTY_PREATTACK_TARGET_CRITICALSTRIKE = 114,
	MODIFIER_PROPERTY_MAGICAL_CONSTANT_BLOCK = 115,
	MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK = 116,
	MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK_SPECIAL = 117,
	MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK_UNAVOIDABLE_PRE_ARMOR = 118,
	MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK = 119,
	MODIFIER_PROPERTY_OVERRIDE_ANIMATION = 120,
	MODIFIER_PROPERTY_OVERRIDE_ANIMATION_WEIGHT = 121,
	MODIFIER_PROPERTY_OVERRIDE_ANIMATION_RATE = 122,
	MODIFIER_PROPERTY_ABSORB_SPELL = 123,
	MODIFIER_PROPERTY_REFLECT_SPELL = 124,
	MODIFIER_PROPERTY_DISABLE_AUTOATTACK = 125,
	MODIFIER_PROPERTY_BONUS_DAY_VISION = 126,
	MODIFIER_PROPERTY_BONUS_NIGHT_VISION = 127,
	MODIFIER_PROPERTY_BONUS_NIGHT_VISION_UNIQUE = 128,
	MODIFIER_PROPERTY_BONUS_VISION_PERCENTAGE = 129,
	MODIFIER_PROPERTY_FIXED_DAY_VISION = 130,
	MODIFIER_PROPERTY_FIXED_NIGHT_VISION = 131,
	MODIFIER_PROPERTY_MIN_HEALTH = 132,
	MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PHYSICAL = 133,
	MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_MAGICAL = 134,
	MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PURE = 135,
	MODIFIER_PROPERTY_IS_ILLUSION = 136,
	MODIFIER_PROPERTY_ILLUSION_LABEL = 137,
	MODIFIER_PROPERTY_STRONG_ILLUSION = 138,
	MODIFIER_PROPERTY_SUPER_ILLUSION = 139,
	MODIFIER_PROPERTY_SUPER_ILLUSION_WITH_ULTIMATE = 140,
	MODIFIER_PROPERTY_TURN_RATE_PERCENTAGE = 141,
	MODIFIER_PROPERTY_TURN_RATE_OVERRIDE = 142,
	MODIFIER_PROPERTY_DISABLE_HEALING = 143,
	MODIFIER_PROPERTY_ALWAYS_ALLOW_ATTACK = 144,
	MODIFIER_PROPERTY_ALWAYS_ETHEREAL_ATTACK = 145,
	MODIFIER_PROPERTY_OVERRIDE_ATTACK_MAGICAL = 146,
	MODIFIER_PROPERTY_UNIT_STATS_NEEDS_REFRESH = 147,
	MODIFIER_PROPERTY_BOUNTY_CREEP_MULTIPLIER = 148,
	MODIFIER_PROPERTY_BOUNTY_OTHER_MULTIPLIER = 149,
	MODIFIER_PROPERTY_UNIT_DISALLOW_UPGRADING = 150,
	MODIFIER_PROPERTY_DODGE_PROJECTILE = 151,
	MODIFIER_PROPERTY_TRIGGER_COSMETIC_AND_END_ATTACK = 152,
	MODIFIER_EVENT_ON_SPELL_TARGET_READY = 153,
	MODIFIER_EVENT_ON_ATTACK_RECORD = 154,
	MODIFIER_EVENT_ON_ATTACK_START = 155,
	MODIFIER_EVENT_ON_ATTACK = 156,
	MODIFIER_EVENT_ON_ATTACK_LANDED = 157,
	MODIFIER_EVENT_ON_ATTACK_FAIL = 158,
	MODIFIER_EVENT_ON_ATTACK_ALLIED = 159,
	MODIFIER_EVENT_ON_PROJECTILE_DODGE = 160,
	MODIFIER_EVENT_ON_ORDER = 161,
	MODIFIER_EVENT_ON_UNIT_MOVED = 162,
	MODIFIER_EVENT_ON_ABILITY_START = 163,
	MODIFIER_EVENT_ON_ABILITY_EXECUTED = 164,
	MODIFIER_EVENT_ON_ABILITY_FULLY_CAST = 165,
	MODIFIER_EVENT_ON_BREAK_INVISIBILITY = 166,
	MODIFIER_EVENT_ON_ABILITY_END_CHANNEL = 167,
	MODIFIER_EVENT_ON_PROCESS_UPGRADE = 168,
	MODIFIER_EVENT_ON_REFRESH = 169,
	MODIFIER_EVENT_ON_TAKEDAMAGE = 170,
	MODIFIER_EVENT_ON_DEATH_PREVENTED = 171,
	MODIFIER_EVENT_ON_STATE_CHANGED = 172,
	MODIFIER_EVENT_ON_ORB_EFFECT = 173,
	MODIFIER_EVENT_ON_PROCESS_CLEAVE = 174,
	MODIFIER_EVENT_ON_DAMAGE_CALCULATED = 175,
	MODIFIER_EVENT_ON_ATTACKED = 176,
	MODIFIER_EVENT_ON_DEATH = 177,
	MODIFIER_EVENT_ON_RESPAWN = 178,
	MODIFIER_EVENT_ON_SPENT_MANA = 179,
	MODIFIER_EVENT_ON_TELEPORTING = 180,
	MODIFIER_EVENT_ON_TELEPORTED = 181,
	MODIFIER_EVENT_ON_SET_LOCATION = 182,
	MODIFIER_EVENT_ON_HEALTH_GAINED = 183,
	MODIFIER_EVENT_ON_MANA_GAINED = 184,
	MODIFIER_EVENT_ON_TAKEDAMAGE_KILLCREDIT = 185,
	MODIFIER_EVENT_ON_HERO_KILLED = 186,
	MODIFIER_EVENT_ON_HEAL_RECEIVED = 187,
	MODIFIER_EVENT_ON_BUILDING_KILLED = 188,
	MODIFIER_EVENT_ON_MODEL_CHANGED = 189,
	MODIFIER_EVENT_ON_MODIFIER_ADDED = 190,
	MODIFIER_PROPERTY_TOOLTIP = 191,
	MODIFIER_PROPERTY_MODEL_CHANGE = 192,
	MODIFIER_PROPERTY_MODEL_SCALE = 193,
	MODIFIER_PROPERTY_IS_SCEPTER = 194,
	MODIFIER_PROPERTY_RADAR_COOLDOWN_REDUCTION = 195,
	MODIFIER_PROPERTY_TRANSLATE_ACTIVITY_MODIFIERS = 196,
	MODIFIER_PROPERTY_TRANSLATE_ATTACK_SOUND = 197,
	MODIFIER_PROPERTY_LIFETIME_FRACTION = 198,
	MODIFIER_PROPERTY_PROVIDES_FOW_POSITION = 199,
	MODIFIER_PROPERTY_SPELLS_REQUIRE_HP = 200,
	MODIFIER_PROPERTY_FORCE_DRAW_MINIMAP = 201,
	MODIFIER_PROPERTY_DISABLE_TURNING = 202,
	MODIFIER_PROPERTY_IGNORE_CAST_ANGLE = 203,
	MODIFIER_PROPERTY_CHANGE_ABILITY_VALUE = 204,
	MODIFIER_PROPERTY_ABILITY_LAYOUT = 205,
	MODIFIER_EVENT_ON_DOMINATED = 206,
	MODIFIER_PROPERTY_TEMPEST_DOUBLE = 207,
	MODIFIER_PROPERTY_PRESERVE_PARTICLES_ON_MODEL_CHANGE = 208,
	MODIFIER_EVENT_ON_ATTACK_FINISHED = 209,
	MODIFIER_PROPERTY_IGNORE_COOLDOWN = 210,
	MODIFIER_PROPERTY_CAN_ATTACK_TREES = 211,
	MODIFIER_PROPERTY_VISUAL_Z_DELTA = 212,
	MODIFIER_PROPERTY_INCOMING_DAMAGE_ILLUSION = 213,
	MODIFIER_PROPERTY_DONT_GIVE_VISION_OF_ATTACKER = 214,
	MODIFIER_PROPERTY_TOOLTIP2 = 215,
	MODIFIER_EVENT_ON_ATTACK_RECORD_DESTROY = 216,
	MODIFIER_EVENT_ON_PROJECTILE_OBSTRUCTION_HIT = 217,
	MODIFIER_PROPERTY_SUPPRESS_TELEPORT = 218,
	MODIFIER_EVENT_ON_ATTACK_CANCELLED = 219,
	MODIFIER_PROPERTY_SUPPRESS_CLEAVE = 220,
	MODIFIER_PROPERTY_BOT_ATTACK_SCORE_BONUS = 221,
