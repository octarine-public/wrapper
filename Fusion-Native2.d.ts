...
declare class CNewParticleEffect extends IParticleEffect {
	...
	readonly m_nSplitScreenUser: number
...
declare class CDOTA_Tree extends CObstructionObject {
	...
	readonly m_bSpecialConsume: boolean
	readonly m_bSpecialPathing: boolean
	readonly m_nOccluderIndex: number
}
...
declare class C_BaseEntity extends C_GameEntity {
	...
	readonly m_nSplitUserPlayerPredictionSlot: number
...
declare class C_BaseModelEntity extends C_BaseEntity {
	...
	//readonly m_Glow: CGlowProperty // actually that's it (TS doesn't allow to override types, but C++ does)
...
declare class C_LightGlow extends C_BaseModelEntity {
	...
	readonly m_flHDRColorScale: number
	// readonly m_Glow: C_LightGlowOverlayy // actually that's it (TS doesn't allow to override types, but C++ does)
}
...
declare class C_PlayerResource extends C_BaseEntity {
	...
	//readonly m_iHealth: number[] // actually that's it (TS doesn't allow to override types, but C++ does)
